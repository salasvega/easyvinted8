...
import { Shield, Clock, Info, Bell, Database } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Accédez à l'interface d'administration pour éditer rapidement vos articles.
          </p>

          <div className="flex justify-start">
            <Button onClick={() => navigate('/admin/unified')} variant="outline">
