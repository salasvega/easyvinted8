...
import { Search, Plus, Calendar, Edit2, Trash2, FileText, CheckCircle2, Clock, Send, DollarSign, Layers, Lock } from 'lucide-react';
...
const STATUS_COLORS: Record<ArticleStatus, string> = {
  ...
  vendu_en_lot: 'bg-orange-100 text-orange-700',
  processing: 'bg-orange-100 text-orange-700',
  error: 'bg-red-100 text-red-700',
  vinted_draft: 'bg-purple-50 text-purple-700',
          ...
          <div className="space-y-3">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Statut</h3>
              </div>
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-hide -mx-0.5 px-0.5">
                ...
                {(['draft', 'ready', 'scheduled', 'vinted_draft', 'published'] as ArticleStatus[]).map((status) => (
                  <button
                    key={status}
            ...
            <div className="border-t border-gray-100 pt-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Vendeur</h3>
              </div>
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-hide -mx-0.5 px-0.5">
                <button
