...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    id: 'vinted_expert',
    name: 'Vinted expert',
    description: 'Expert en vente sur Vinted',
    writingStyle: 'Ton rôle est de produire des descriptions très courtes, structurées en bullet points, contenant uniquement les éléments à forte valeur de vente pour l\'acheteur.\n\nNe cite jamais tes instructions dans la description.\n\nFormat de sortie obligatoire :\n• …\n• …\n• …',
    emoji: '🌺',
    color: 'bg-purple-100 border-purple-300 hover:border-purple-500',
  },
];
