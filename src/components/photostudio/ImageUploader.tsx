  ...
  return (
    <div className="w-full">
      {isCameraOpen ? (
        <div className="relative bg-black rounded-xl overflow-hidden aspect-video flex items-center justify-center">
           ...
           <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4">
             ...
             <button
               ...
               className="p-4 bg-white text-blue-600 rounded-full hover:bg-gray-100 transition ring-4 ring-blue-500/30 shadow-lg"
               title="Capture Photo"
             >
               <Camera size={28} />
             </button>
        ...
        <div
          className="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-blue-500 hover:bg-blue-50/30 transition-all group cursor-pointer"
