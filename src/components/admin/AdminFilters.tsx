...
const STATUS_CONFIG: Record<ArticleStatus, { label: string; color: string; activeColor: string }> = {
  ...
  vendu_en_lot: { label: 'Vendu en lot', color: 'bg-teal-50 text-teal-600 border-teal-200', activeColor: 'bg-teal-600 text-white border-teal-600' },
  processing: { label: 'En cours', color: 'bg-orange-50 text-orange-600 border-orange-200', activeColor: 'bg-orange-600 text-white border-orange-600' },
  error: { label: 'Erreur', color: 'bg-red-50 text-red-600 border-red-200', activeColor: 'bg-red-600 text-white border-red-600' },
  vinted_draft: { label: 'Brouillon Vinted', color: 'bg-violet-50 text-violet-600 border-violet-200', activeColor: 'bg-violet-600 text-white border-violet-600' },
  reserved: { label: 'Réservé', color: 'bg-gray-50 text-gray-600 border-gray-200', activeColor: 'bg-gray-600 text-white border-gray-600' },
};
...
const renderStatusIcon = (status: ArticleStatus) => {
  ...
  switch (status) {
    ...
    case 'reserved': return <Lock className={iconClass} />;
    default: return null;
  }
};
