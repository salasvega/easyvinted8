      ...
      <div className="max-w-7xl mx-auto px-6 pt-3 pb-16">
                ...
                <SectionCard title="Génération par Description Textuelle" subtitle="L'IA créera votre modèle à partir de votre description" delay={0}>
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {(!textGenerationName.trim() || !textGenerationDescription.trim()) && !isGeneratingFromText && (
                        <p className="text-xs text-red-500 text-center">
                          {!textGenerationName.trim() && !textGenerationDescription.trim()
                            ? 'Veuillez saisir un nom et une description'
                            : !textGenerationName.trim()
                            ? 'Veuillez saisir un nom pour le modèle'
                            : 'Veuillez saisir une description du modèle'}
                        </p>
                      )}
                    </div>
                  </div>
        ...
        {state.step === 'garment' && (
          <div className="max-w-7xl mx-auto animate-in fade-in zoom-in-95 duration-1000">
            <SectionHeader title="Testez les competences et le style de votre avatar" subtitle="Selectionnez votre modèle, un fond de photo et l'article de votre choix. Laissez votre avatar faires ses preuves, si il n'est pas assez convainquant choisissez en un autre plus swag :)" />
        ...
        {state.step === 'gallery' && (
          <div className="animate-in fade-in duration-700">
            <SectionHeader title="Modèle" subtitle="Définissez le modèle qui portera vos articles sur les annonces de vente :)
" />
